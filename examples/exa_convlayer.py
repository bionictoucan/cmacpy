...
intuitively makes some sense since the neighbouring pixels in an image are
typically strongly correlated. This is shown pictorially below.
...
#     layer.
# 
# Starting with the number of output channels: this is the number of feature
# maps you wish your convolutional layer to produce and consequently how many
# learnable kernels you define for the layer. This parameter links nicely to the
# size of the kernels used. This is the dimensions of the matrix of a single
# kernel to be used in the convolutional layer. This can be given as a single
# number meaning both dimensions would have that number or as a sequence of
# numbers defining the number of rows and columns, respectively. This parameter
# controls the number of learnable parameters there are per kernel. This can be
# thought of as how much of the surrounding information in the image is used to
# calculate an entry in a feature map: a bigger kernel will use more of the
# surrounding pixels to extract information and vice versa. One is not
# necessarily better than the other, this is a parameter that can be played with
# to see if it affects the learning performance.
# 
# The number of input channels can be one of two properties: either the number
# of channels of your image or the number of output feature maps of a preceding
# convolutional layer. Let's start with the first definition.
# 
# 
